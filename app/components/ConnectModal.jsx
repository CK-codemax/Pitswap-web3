  ...
  useEffect(
   ...
   return () => document.removeEventListener('click', handleClick, true)
    ...
    return createPortal(
        ...
        <div ref={windowRef}  className="fixed w-[90%] sm:w-[70%] lg:w-[400px] top-[50%] py-6 bg-gray-800 border-black border px-4 shadow-[0 2.4rem 3.2rem rgba(0, 0, 0, 0.12)] flex flex-col space-y-4 justify-center rounded-2xl left-[50%] -translate-x-[50%] -translate-y-[50%]">
